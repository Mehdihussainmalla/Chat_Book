...
{ key: 9, file: "my uploads on ", image: imagePath.post_image },]
const MyProfileUploads = () => {
    ...
    const renderItem = ({ item }) => {
        return (
            ...
            <TouchableOpacity
                activeOpacity={0.8}
                style={{ marginTop: 10, marginHorizontal:8, borderWidth: 0.5, }}>
...
export default MyProfileUploads;
